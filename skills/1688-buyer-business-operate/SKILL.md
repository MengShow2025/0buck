...
dependencies:
  ...
  - name: search-1688-supplier
    source: https://clawhub.1688.com/skill/skill-9348eb2903fa08ed
    description: 供应商搜索 - 搜索和筛选1688供应商，支持链接/图片/关键词三种方式
---
...
⚠️ **重要：1688-buyer-ops 依赖以下子skill才能完整运行。首次使用前请先安装！**

| Skill | 功能 | 安装命令 |
|-------|------|---------|
| ✅ amazon-product-search | **亚马逊/TikTok选品** | [安装](https://clawhub.1688.com/skill/skill-4fb1b905ebaf6734) |
| ✅ search-1688-supplier | **1688供应商搜索** | [安装](https://clawhub.1688.com/skill/skill-9348eb2903fa08ed) |
| ✅ query-1688-product-detail | 1688商品详情 | [安装](https://clawhub.1688.com/skill/skill-afcd63a8aa94e66e) |
| ✅ inquiry-1688 | 向供应商询盘 | [安装](https://clawhub.1688.com/skill/skill-ea9b968f5213ecec) |
| ✅ alphashop-image | 图片处理 | [安装](https://clawhub.1688.com/skill/skill-7e2f425dbef5cb3a) |
| ⚠️ 1688-ranking | 1688榜单（需API权限） | [安装](https://clawhub.1688.com/skill/skill-a07ec1ae25ee536c) |
| ⚠️ 1688-google-trends | Google趋势分析 | [安装](https://clawhub.1688.com/skill/skill-f3de4a15056a585b) |

**一键安装命令**：
```
请帮我安装以下 skills：
1. amazon-product-search：https://clawhub.1688.com/skill/skill-4fb1b905ebaf6734
2. search-1688-supplier：https://clawhub.1688.com/skill/skill-9348eb2903fa08ed
3. query-1688-product-detail：https://clawhub.1688.com/skill/skill-afcd63a8aa94e66e
4. inquiry-1688：https://clawhub.1688.com/skill/skill-ea9b968f5213ecec
5. alphashop-image：https://clawhub.1688.com/skill/skill-7e2f425dbef5cb3a
6. 1688-ranking：https://clawhub.1688.com/skill/skill-a07ec1ae25ee536c
7. 1688-google-trends：https://clawhub.1688.com/skill/skill-f3de4a15056a585b
```
...
**以下场景必须调用对应子skill，禁止使用Web Search：**

| 用户需求 | 必须使用的skill | 原因 |
|---------|----------------|------|
| 找亚马逊/亚马逊商品 | `amazon-product-search` | 有结构化销量/评分数据 |
| 找TikTok商品 | `amazon-product-search` | 支持TikTok平台 |
| 找1688供应商 | `search-1688-supplier` | AlphaShop官方API |
| 找1688货源 | `search-1688-supplier` | 支持链接/图片/关键词搜索 |
| 查1688商品详情 | `query-1688-product-detail` | 完整SKU/规格数据 |
| 向供应商询盘 | `inquiry-1688` | 支持多轮对话 |
| 图片翻译/抠图 | `alphashop-image` | 官方图像处理API |
| 模特换肤/试衣 | `alphashop-image` | 官方虚拟试衣API |
| 查1688榜单 | `1688-ranking` | 1688官方榜单数据 |
| 查Google趋势 | `1688-google-trends` | 搜索热度分析 |

### 🌐 可以使用Web Search的场景

以下场景超出skill数据边界，**可以使用Web Search补充**：
...
### 2. 供应商分析 (`search-1688-supplier` skill)

**功能**：通过 AlphaShop API 搜索和筛选1688供应商，支持三种输入方式：1688商品链接、图片URL、文字关键词。

**触发场景**：找供应商、搜索工厂、以图找商、找商家。
...
|------|------|
| 1688链接搜索 | 查找特定商品的供应商 |
| 图片URL搜索 | 以图搜货，快速找到相似商品供应商 |
| 关键词搜索 | 按关键词搜索供应商 |
| 筛选功能 | 支持价格、MOQ、48H发货率筛选 |
...
| `search-1688-supplier` | 供应商搜索 | `.qoder/skills/search-1688-supplier/SKILL.md` |
